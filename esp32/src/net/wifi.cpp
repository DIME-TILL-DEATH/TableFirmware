...
void WIFI_Init(void)
{
   ...
   // IP_ADDR4(&DNS_ipInfo.ip, 0, 0, 0, 0);
    ...
    std::string wifiSSID = Settings::getStringSetting(Settings::String::WIFI_SSID);
    std::string wifiPassword = Settings::getStringSetting(Settings::String::WIFI_PASSWORD);
